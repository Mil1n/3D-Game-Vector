...
const NULL_LATTICE = {
  ...
  hazards: {
    zones: [
      {
        id: 'null-discharge',
        name: 'Импульсный разлом',
        cause: 'Разряд Нулевой решётки',
        position: [24.5, 2.55, 11.2],
        radius: 3,
        triggerHeight: 2.6,
        initialDelay: 5.5,
...
const ZENITH_FORGE = {
  ...
  hazards: {
    zones: [
      {
        id: 'forge-vent',
        name: 'Термический сброс',
        cause: 'Выброс Небесной литейной',
        position: [-17.83, 7.05, -39.13],
        radius: 3,
        triggerHeight: 2.6,
        initialDelay: 6.8,
        ...
        tickInterval: 0.75,
        damage: 10,
        warningColor: 0xffc45c,
        activeColor: 0xff4d24,
      },
    ],
  },
  spawns: {
    ...
    zones: [
      {
        id: 'relay-arc-spill',
        name: 'Дуговой разлив',
        cause: 'Разряд ретранслятора',
        position: [-48, 0, 12],
        radius: 3,
        triggerHeight: 2.6,
        initialDelay: 4.8,
        telegraphDuration: 1.45,
        activeDuration: 2.7,
        cooldown: 7.2,
        tickInterval: 0.7,
        damage: 9,
        activeColor: 0xff477b,
      },
    ],
  },
  spawns: {
